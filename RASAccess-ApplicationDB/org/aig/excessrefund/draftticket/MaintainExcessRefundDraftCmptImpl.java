package org.aig.excessrefund.draftticket;
...
public class MaintainExcessRefundDraftCmptImpl {
	/**
	 * Default constructor.
	 */
	public MaintainExcessRefundDraftCmptImpl() {
		super();
	}
	...
	/**
	 * Method generated to support implementation of operation "saveDraftTicket" defined for WSDL port type 
	 * named "MaintainExcessRefundDraft".
	 * 
	 * The presence of commonj.sdo.DataObject as the return type and/or as a parameter 
	 * type conveys that it is a complex type. Please refer to the WSDL Definition for more information 
	 * on the type of input, output and fault(s).
	 */
	public DataObject saveDraftTicket(DataObject daftTicketDetails) {
		...
		//
		// To get or set attributes for a DataObject such as daftTicketDetails, use the APIs as shown below:
		// To set a string attribute in daftTicketDetails, use daftTicketDetails.setString(stringAttributeName, stringValue)
		// To get a string attribute in daftTicketDetails, use daftTicketDetails.getString(stringAttributeName)
		// To set a dataObject attribute in daftTicketDetails, use daftTicketDetails.setDataObject(stringAttributeName, dataObjectValue)
		// To get a dataObject attribute in daftTicketDetails, use daftTicketDetails.getDataObject(stringAttributeName)
		return null;
	}
