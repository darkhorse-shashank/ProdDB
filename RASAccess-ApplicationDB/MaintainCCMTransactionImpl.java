...
public class MaintainCCMTransactionImpl {
	/**
	 * Default constructor.
	 */
	public MaintainCCMTransactionImpl() {
		super();
	}
	...
	/**
	 * Method generated to support implementation of operation "getCCMRequestId" defined for WSDL port type 
	 * named "MaintainCCMTransaction".
	 * 
	 * Please refer to the WSDL Definition for more information 
	 * on the type of input, output and fault(s).
	 */
	public String getCCMRequestId(String category) {
		//TODO Needs to be implemented.
		Integer nextValue=0;
		if("CCM REQUEST ID".equalsIgnoreCase(category))
		{
		DataObject cmmTransactionRequestIdBG = getBOFactory()
				.create("http://www.ibm.com/xmlns/prod/websphere/j2ca/jdbc/ccmrequestidbg",
						"CCMRequestIDBG");
		DataObject cmmTransactionRequestId = getBOFactory()
				.create("http://www.ibm.com/xmlns/prod/websphere/j2ca/jdbc/ccmrequestid",
						"CCMRequestID");
		...
		cmmTransactionRequestIdBG.setDataObject("CCMRequestID", cmmTransactionRequestId);
		
		DataObject ccmTransactionRequestSeries = (DataObject) locateService_DBInterfacePartner().invoke(
				"retrieveallCCMRequestIDBG", cmmTransactionRequestIdBG);
		 
		nextValue = 
				ccmTransactionRequestSeries.getInt("retrieveallCCMRequestIDBGOutput/CCMRequestID/next_value");
